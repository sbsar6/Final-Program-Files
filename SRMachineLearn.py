...
def machLearn(path):
    ...
    # Instantiating and Fitting Data to Random Forest and Support Vector Algorithms
    ...
    bar = Bar(ranks,features,title="Super Rugby Feature Rankings",palette=brewer["Blues"][3], stacked=True)
    
    output_file("Super Rugby rankings.html")
    show(bar)
